...
export function createOneFileChat(userId, friendId, connection) {
    return query(`INSERT INTO ${TABLE_NAME}(user_id, friend_id, type, content) VALUES(?, ?, ?, ?)`, [userId, friendId, chatType.FILE, ''], connection)
}